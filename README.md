[![Build status](https://ci.appveyor.com/api/projects/status/7tsves7dbn0we47w?svg=true)](https://ci.appveyor.com/project/finchik/n-ra-hw-2-event-state-layouts)

### [Ссылка на Github Pages](https://finchik.github.io/n-ra-hw.-2_event-state_layouts/)
